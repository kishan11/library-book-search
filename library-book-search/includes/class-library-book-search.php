...
class Library_Book_Search {
	...
	private function load_dependencies() {
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/partials/library-book-search-admin-display.php';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin_screen = new Library_Book_Search_Admin_Screen( $this->get_plugin_name(), $this->get_version() );

		$this->loader->add_action( 'admin_enqueue_scripts', $plugin_admin, 'enqueue_styles' );
		$this->loader->add_action( 'admin_enqueue_scripts', $plugin_admin, 'enqueue_scripts' );
		
		$this->loader->add_action( 'init', $plugin_admin, 'lbs_define_book_post_and_taxonomy' );
		
		$this->loader->add_action( 'add_meta_boxes', $plugin_admin, 'lbs_book_meta_boxes' );
		
		$this->loader->add_action( 'save_post_books', $plugin_admin, 'lbs_book_save_meta_boxes' );
		
		$this->loader->add_action( 'admin_menu', $plugin_admin_screen, 'lbs_book_admin_menu' );
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action( 'init', $plugin_public, 'lbs_book_form_shortcode' );
		
		$this->loader->add_action( 'wp_ajax_book_search_ajax', $plugin_public, 'book_search_ajax_result' );
		$this->loader->add_action( 'wp_ajax_nopriv_book_search_ajax', $plugin_public, 'book_search_ajax_result' );
		
		$this->loader->add_filter( 'template_include', $plugin_public, 'book_single_page_template' );
